...
//
// https://github.com/wasmerio/go-ext-wasm/pull/95/files
//
package wasmexec
...
//
// // For TinyGo.
// extern int32_t wasi_unstable_fd_write(void *context, int32_t a, int32_t b, int32_t c, int32_t d);
...
//export wasi_unstable_fd_write
func wasi_unstable_fd_write(context unsafe.Pointer, a int32, b int32, c int32, d int32) int32 {
...
var hostFunctions = HostFunctionNamespaces{
	"wasi_unstable": {
		"fd_write": HostFunction{
			Go: wasi_unstable_fd_write,
			C:  C.wasi_unstable_fd_write,
		},
	},
	"env": {
